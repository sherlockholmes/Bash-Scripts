...
#Obviamente debemos cambiar las direcciones IP y la ruta de las llaves .pem
case "$1" in
	# aliasdelserver) comando a ejecutar cuando la variable $1 contenga el alias. 
	"AWS-WEB-001" | "web01" | "148.76.153.137") ssh -i $HOME/keydir/web01.pem root@148.76.153.137;;
